"""Build farada_model_v5 (FINAL) from v4 — cash-flow + ProForma/IS re-architecture + completion.
...
Reads v4 (preserved), writes the FINAL farada_model_v5.xlsx. Idempotent.
Run:  .venv/bin/python clients/farada/one_offs/build_model_v5.py
"""
...
DST = "clients/farada/modeling/farada_model_v5.xlsx"
FIRST, LAST = 3, 62
