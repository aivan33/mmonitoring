...
LAYOUT = [
    ...
    *NEW(("Bundle S", "%"), ("Bundle M", "%"), ("Bundle L", "%")), B,
    ...
    S("3.3", "Cost of sales — yield & sensors per wafer (staged by run-rate)"),
    *NEW(("Sensors per wafer", "# /wafer"),
         ("Yield @ 1 /yr", "%"), ("Yield @ 10,000 /yr", "%"), ("Yield @ 100,000 /yr", "%"),
         ("Yield @ 1,000,000 /yr", "%"), ("Yield @ 4,000,000 /yr", "%")), B,
    S("3.4", "Cost of sales — packaging (€/sensor)"), *K(69, 70, 71, 72, 73, 74), B,
    S("3.5", "Cost of sales — sensor testing (€/sensor)"), *K(76, 77, 78, 79, 80, 81), B,
    S("3.6", "Cost of sales — final testing (€/sensor)"), *K(83, 84, 85, 86, 87, 88), B,
    S("3.7", "Cost of sales — ASIC / readout (€/sensor)"), *K(90, 91, 92, 93, 94, 95), B,
    S("3.8", "Cost of sales — usage & parameters"), *K(102, 107, 108), B,
